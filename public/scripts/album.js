...
var getSongNumberCell = function(number) {
    console.log(
        "line22 setsongnumcell=", $('.song-item-number[data-song-number="' + number + '"]').html()
    );
...
var createSongRow = function(songNumber, songName, songLength) {
    ...
    var clickHandler = function() {
        ...
        if (debug // =="on"
            ...
            console.log(
				...
				"\n songNumber =>", songNumber, "\n currentSongFromAlbum.audioUrl=>", currentSongFromAlbum //.audioUrl
                , "\n this.parent=>", "\n" + $(this).parent().html(), 
				"\n currentSoundFile =>", currentSoundFile, "\n isPaused", currentSoundFile ? currentSoundFile.isPaused() : null

                , "\n currentlyPlayingSongNumber !== null =", currentlyPlayingSongNumber !== null

                , "\n currentlyPlayingSongNumber == songNumber =", currentlyPlayingSongNumber === songNumber
    ...
    var onHover = function(event) {
        ...
        if (debug == "on") {
            console.log(
                "onhover line95 this=", $(this).html(), "songnum not currentplaying num=", songNumber != currentlyPlayingSongNumber
            );
        }
    ...
    var offHover = function(event) {
        ...
        if (debug == "on") {
            console.log(
                "offhover songnum not curntplaysong=", songNumber /*.toString()*/ != currentlyPlayingSongNumber
            );
        }
        if (songNumber != currentlyPlayingSongNumber) {

            if (debug == "on") {
                console.log("offhover-line98= ", songNumber != currentlyPlayingSongNumber, "songNumber=", songNumber,
				'currentlyPlayingSongNumber=', currentlyPlayingSongNumber, "songNumberCell.html()=", songNumberCell.html(), songNumber)
            }
...
var output = function() {
    ...
    console.log(
        ...
        //,currentAlbum
        , "\n currentlyPlayingSongNumber =>", currentlyPlayingSongNumber,
		"\n currentSongFromAlbum =>", currentSongFromAlbum, "\n currentSoundFile =>", 
		currentSoundFile, "\n isPaused", currentSoundFile.isPaused(),
		"\n currentSongFromAlbum.audioUrl=>", currentSongFromAlbum.audioUrl
        //,"\n this"
        //,this
